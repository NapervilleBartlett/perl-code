...
# Usage:  PlotPM_Graph_AllDay.pl    file_name.csv   Title        DestinationDir
...
sub Merge_PM_Plots
{
	...
	print "Idrees starting Merge_PM_Plots. Pm_Name=$Pm_Name= \n";
	...
	print "Idrees exiting Merge_PM_Plots \n";
...
sub Plot_PM
{
	...
	print "Idrees staring Plot_PM . title=$title= Pm_Name=$Pm_Name= \n";
...
@line_Colors = (0x53c613, 0xc61253, 0xA00404, 0x0000FF, 0xFF9000, 0x800080, 0xcc9966, 0xFF0000, 0x000000 );
#The labels for the line chart
# my $labels = ["00", "05", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55"];
my $labels = ["00-15", "15-30", "30-45", "45-00" ];
